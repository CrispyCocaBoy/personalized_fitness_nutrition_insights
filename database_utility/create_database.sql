...
--    Specifies which physical sensors are mounted on each device type
...
-- 9. SENSOR_TO_USER (USER-ASSOCIATED SENSOR)
--    Maps a physical sensor type to a specific user device
...
--     Stores which features each user wants to monitor on a specific device
...
-- Default sensor mapping per device type
-- Priority: 1 = highest, 3 = lowest

-- SimpleWatch: supports all sensors, good overall accuracy
INSERT INTO predefined_device_type_sensors (device_type_id, sensor_type_id, priority) VALUES
(1, 1, 2),  -- PPG
(1, 2, 2),  -- Skin Temperature
(1, 3, 1),  -- Accelerometer
(1, 4, 1),  -- Gyroscope
(1, 5, 1),  -- Altimeter
(1, 6, 1),  -- Barometer
...
-- SimpleBand: fewer sensors but better fit and stability
INSERT INTO predefined_device_type_sensors (device_type_id, sensor_type_id, priority) VALUES
(2, 1, 1),  -- PPG (more stable on wrist)
(2, 3, 2),  -- Accelerometer
(2, 7, 1);  -- cEDA

-- SimpleRing: compact, accurate for skin contact
INSERT INTO predefined_device_type_sensors (device_type_id, sensor_type_id, priority) VALUES
(3, 1, 3),  -- PPG (less stable)
(3, 2, 1);  -- Skin Temperature (best placement)

-- Phone: basic motion tracking only
INSERT INTO predefined_device_type_sensors (device_type_id, sensor_type_id, priority) VALUES
(4, 3, 3),  -- Accelerometer (less reliable for activity)
(4, 4, 3);  -- Gyroscope